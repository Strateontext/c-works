...
namespace KeyboardInputForm
{
    class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            this.panel14.Location = new System.Drawing.Point(50, 50);
            this.panel14.Name = "panel12";
            this.panel14.Size = new System.Drawing.Size(70, 44);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            while (dX < 750)
            {
                this.panel14.Location = new System.Drawing.Point(panel14.Location.X + 5, panel14.Location.Y);
                this.panel14.Size = new System.Drawing.Size(70, 44);
                System.Threading.Thread.Sleep(1);
                dX += 5;
                if ((panel14.Location.X == 675) & (panel14.Location.Y > 12 & panel14.Location.Y < 165))
                {
                    score++;
            ...
            while (dY < 400)
            {
                this.panel14.Location = new System.Drawing.Point(panel14.Location.X, panel14.Location.Y + 5);
                this.panel14.Size = new System.Drawing.Size(70, 44);
                System.Threading.Thread.Sleep(1);
                dY += 5;
            }
        ...
        private void key_A_pressed(object sender, KeyPressEventArgs e)
        {
         if (e.KeyChar == 119)//w
            {
                this.panel12.Location = new System.Drawing.Point(panel12.Location.X, panel12.Location.Y - 7);
         ...
         if (e.KeyChar == 100)//d
            {
                this.panel12.Location = new System.Drawing.Point(panel12.Location.X + 7, panel12.Location.Y);
                this.panel12.Size = new System.Drawing.Size(70, 44);                
            }
         if (e.KeyChar == 97)//a
            {
